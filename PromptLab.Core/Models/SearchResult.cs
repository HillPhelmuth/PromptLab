...
namespace PromptLab.Core.Models
{
    public class SearchResult
    {
        ...
        public List<BingSearchResult> BingSearchResults => WebPages?.PageInfo?.Select(x => new BingSearchResult(x.Url, x.Snippet, x.DisplayUrl, x.Name) { WebSearchUrl = WebPages?.WebSearchUrl, DateLastCrawled = x.DateLastCrawled}).ToList() ?? [];
    }
