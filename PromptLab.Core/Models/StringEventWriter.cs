...
public class StringEventWriterLogger(StringEventWriter stringEventWriter) : ILogger
{
...
#pragma warning restore CS8633 // Nullability in constraints for type parameter doesn't match the constraints for type parameter in implicitly implemented interface method'.
    ...
    {
        stringEventWriter.WriteLine(formatter(state, exception!));
    }
}

public class StringEventWriterLoggerProvider(StringEventWriter stringEventWriter) : ILoggerProvider
{
    public ILogger CreateLogger(string categoryName)
    {
        return new StringEventWriterLogger(stringEventWriter);
    }
